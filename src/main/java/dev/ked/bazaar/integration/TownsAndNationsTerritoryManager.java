 ...
 */
public class TownsAndNationsTerritoryManager implements dev.ked.bazaar.integration.TerritoryManager {
    ...
    public String getTerritoryId(Location location) {
        ...
        // Use territory ID from TaN
        return "tan:" + territoryOpt.get().getID();
    }
}
